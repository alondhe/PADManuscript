...
OhdsiRTools::checkUsagePackage("PADManuscript")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/PADManuscript.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PADManuscript.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("PADManuscript")
